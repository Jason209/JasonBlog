...
html5sticky.addNote = function(){
    ...
    var stickynote = $('<div class="note_common ' + bgcolor + ' ' + rotationClass + '" />').appendTo($('#localstorage'));
   ...
   if (Modernizr.localstorage){
      for(var i = 1; i <= max_notes; i++){
         ...
         if (localStorage.getItem(i + 'stickynote')){
            ...
            stickynote = $('<div class="note_common ' + bgcolor + ' ' + rotationClass + '" />').appendTo($('#localstorage'));
            // add tape to stickynote
            html5sticky.addPin(stickynote);
